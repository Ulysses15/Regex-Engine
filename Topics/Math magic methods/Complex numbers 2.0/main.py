class ComplexNumber:
    ...
    def __truediv__(self, other):
        ...
        real_other = other.real_part / divisor
        imaginary_other = (-1) * other.im_part / divisor
        real = self.real_part * real_other - self.im_part * imaginary_other
        imaginary = self.real_part * imaginary_other + real_other * self.im_part
        return ComplexNumber(real, imaginary)
